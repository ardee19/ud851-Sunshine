...
//      COMPLETED (7) Replace the single TextView with Views to display all of the weather info
        ...
        String highInCelsiusString = SunshineWeatherUtils.formatTemperature(mContext, highInCelsius);
        String highA11y = mContext.getString(R.string.a11y_high_temp, highInCelsiusString);

        String lowInCelciusString = SunshineWeatherUtils.formatTemperature(mContext, lowInCelsius);
        String lowA11y = mContext.getString(R.string.a11y_low_temp, lowInCelciusString);
        ...
        forecastAdapterViewHolder.highTempView.setText(highInCelsiusString);
        forecastAdapterViewHolder.highTempView.setContentDescription(highA11y);

        forecastAdapterViewHolder.lowTempView.setText(lowInCelciusString);
...
//          COMPLETED (6) Get references to all new views and delete this line
            dateView = (TextView) view.findViewById(R.id.tv_weather_date);
            descriptionView = (TextView) view.findViewById(R.id.tv_weather_description);
            highTempView = (TextView) view.findViewById(R.id.tv_high_temperature);
            lowTempView = (TextView) view.findViewById(R.id.tv_low_temperature);
