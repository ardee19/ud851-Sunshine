...
public class SunshinePreferences {
    ...
    public static String getPreferredWeatherLocation(Context context) {
        ...
        String preferredWeatherLocation = sharedPreferences.getString(context.getString(R.string.pref_location_key),
    ...
    public static boolean isMetric(Context context) {
        ...
        /** This will be implemented in a future lesson **/
        SharedPreferences sharedPreferences = PreferenceManager.getDefaultSharedPreferences(context);
        String preferredTemperatureUnit = sharedPreferences
                .getString(context.getString(R.string.pref_units_key),context.getString(R.string.pref_units_metric));
        if (preferredTemperatureUnit.equals(context.getString(R.string.pref_units_metric))) {
            return  true;
        } else {
            return false;
        }
