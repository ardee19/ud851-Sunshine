...
//              COMPLETED (15) If more than a day have passed and notifications are enabled, notify the user
                boolean oneDayHasPassedSinceLastNotification = false;
                if (timeSinceLastNotification >= DateUtils.DAY_IN_MILLIS) {
                    oneDayHasPassedSinceLastNotification = true;
                }

                if (notificationsEnabled && oneDayHasPassedSinceLastNotification) {
